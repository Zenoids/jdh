    ...
    return (
        ...
        <>
            <div className="relative h-[296px] w-1/4  ">
                ...
                <div   className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden  bg-[#1e792d] bg-fixed opacity-40 transition duration-300 ease-in-out hover:opacity-0"></div>
