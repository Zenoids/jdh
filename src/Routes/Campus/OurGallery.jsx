...
function OurGallery() {
  ...
  <div class="container px-5 py-24 mx-auto my-auto mt-10 flex flex-wrap">
    <div class="flex w-full mb-20 flex-wrap">
      <h1 class="sm:text-3xl text-2xl text-center font-medium title-font text-gray-900  lg:mb-0 mb-4">JDH Gallery and Collection</h1>
