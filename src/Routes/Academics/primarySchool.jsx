  ...
  return (
    <>
      <div className='relative bg-gray-200 flex flex-col items-center justify-center'>
        ...
        <h1 className=" absolute  text-6xl  text-black text-center">Primary School
        <span>
        ...
        <button class=" flex mx-auto mt-8 px-8 py-2  text-white bg-green-900 border-0 focus:outline-none hover:bg-indigo-600 rounded text-lg">TAKE A TOUR</button> 
        </span>
        </h1>
      ...
      {/* images in order */}
                <div className="flex  ">
                    <img src="/Events/sc.png" alt="" />
                         <div className="flex flex-col">
                            <img src="/Events/cl.png" alt="" />
                             <img src="/Events/com.png" alt="" />
                        </div>
                </div>
            </div>
        </div>
...
<div  class="text-center mt-8 mb-8">
      ...
      <p class="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Our students are creatuve, hard-working and full of good ideas. We encourage and empower them to bring their ideas to life. Hands-on opportunities are what we're all about.</p>
    ...
    <Highschoolcard img="/Events/award.png" head="Awarding" para="Duis autem vel eum iriure dolor"/>
      ...
      <div   className="container  mx-auto mb-10 mt-10 bg-green-900  py-4 text-white">
        <div className="flex ">
          ...
          <div className='flex flex-col  '>
            <h1 className='text-4xl mt-8 mx-8'>Our Students are creative</h1>
        ...
        <button class=" flex mx-auto mt-8 px-8 py-2  text-black bg-[#DCDFB1] border-0 focus:outline-none hover:bg-red-900 hover:text-white  rounded-full text-lg">Learn More</button> 
      </div>
